...
<div style="font-weight: 700; color: #2563eb; font-size: 0.85rem;">Type 1</div>
<div style="color: #6b7280; font-size: 0.75rem;">What is X% of Y?</div>
</div>
<div style="padding: 1rem; background: #f0fdf4; border-radius: 10px; border: 1px solid #bbf7d0; text-align: center;">
<div style="font-size: 1.5rem;">📊</div>
<div style="font-weight: 700; color: #16a34a; font-size: 0.85rem;">Type 2</div>
<div style="color: #6b7280; font-size: 0.75rem;">X is what % of Y?</div>
</div>
<div style="padding: 1rem; background: #faf5ff; border-radius: 10px; border: 1px solid #e9d5ff; text-align: center;">
<div style="font-size: 1.5rem;">🔄</div>
<div style="font-weight: 700; color: #7c3aed; font-size: 0.85rem;">Type 3</div>
<div style="color: #6b7280; font-size: 0.75rem;">X is Y% of what?</div>
</div>
</div>
